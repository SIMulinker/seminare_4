...
$worked = [
		'post' => ['Front End Developer', 'Web Developer / something.com', 'Graphic Designer / designsomething.com', 'Simple Garson on Net.Cafe.'],
		'datego' => ['Jan 2015', 'Mar 2012', 'Jun 2010', 'Jul 2008'],
        'enddate' => ['Active', 'Dec 2014', 'Mar 2012', 'Apr 2010'],
...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
     ...
     <?php for($i=0,$size=count($worked);$i<=$size;$i++):?>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $worked['post'][$i]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $worked['datego'][$i]; ?> - <?php if(0 ==$i){echo '<span class="w3-tag w3-teal w3-round">Current</span>';}else{echo $worked['enddate'][$i];}?> </h6>
          <!-- maybe this a creating finest...some later -->
          <p><?php echo $worked['description'][$i]; ?></p>
          <hr>
        </div>
        <?php endfor   ?>
